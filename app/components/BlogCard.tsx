  ...
  return (
    ...
    >
      ...
      <div className="p-6 flex-col ">
        <h2 className="text-sm text-gray-800 dark:text-gray-300 mb-4 line-clamp-3 leading-relaxed bg-white/50 dark:bg-gray-800/50 p-3 rounded-lg flex-grow">
          {article.title}
        </h2>
        ...
        <p className="text-sm text-gray-700 dark:text-gray-200 mb-2 font-medium">
          By{" "}
          <Link
            href={`/author/${encodeURIComponent(article.user.username)}${
